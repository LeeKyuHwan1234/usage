...
[AI Usage Dashboard 배포본 보기](https://github.com/LeeKyuHwan1234/usage/releases)
...
이 저장소의 최신 Release ZIP(또는 폴더 전체)을 전달하세요. 받는 사람은 압축을 풀고 `AI Usage Dashboard.vbs`를 더블클릭하면 됩니다. `assets` 폴더도 반드시 함께 포함되어야 작업표시줄 아이콘이 정상 표시됩니다.
